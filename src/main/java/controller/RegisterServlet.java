...
public class RegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (hasInserted) {
				out.println(
						"<script>alert('User registered successfully!'); window.location='register/registration.jsp';</script>");
			} else {
				out.println(
						"<script>alert('Failed to register user. Try again.'); window.location='register/registration.jsp';</script>");
			}
		} catch (ClassNotFoundException | SQLException e) {
			e.printStackTrace();
			out.println(
					"<script>alert('Database error occurred. Contact admin.'); window.location='register/registration.jsp';</script>");
		}
	}
