            ...
            <section class="about-section">
                <div class="about-container">
                    <div class="about-image">
                        <img src="https://c.static-nike.com/a/images/w_1920,c_limit/bzl2wmsfh7kgdkufrrjt/the-beginning-1985-1986-air-jordan-i.jpg"
                            alt="Jordan Legacy" />
                    </div>
                ...
                <div class="team-container">
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://randomuser.me/api/portraits/men/42.jpg" alt="Team Member" />
                        </div>
                        <h3>James Wilson</h3>
                        <p>Founder & CEO</p>
                        <p>Sneaker collector for over 15 years</p>
                    </div>
                    <div class="team-member">
                        <div class="member-image">
                        ...
                        <p>Former professional basketball player</p>
                    </div>
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Team Member" />
                        </div>
                        <h3>Darnell Rodriguez</h3>
                        <p>Authentication Expert</p>
                        <p>Certified sneaker authenticator</p>
                    </div>
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://randomuser.me/api/portraits/women/46.jpg" alt="Team Member" />
                        </div>
                        <h3>Aisha Williams</h3>
                        <p>Customer Experience</p>
                        <p>Ensuring you have the best experience</p>
                    </div>
                </div>
            </section>
        </main>
