...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/resources/fonts/fonts/material-icon/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/logincss/style.css">
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-image">
                    <figure>
                        <img src="<%= request.getContextPath() %>resources/images/images/signup-image.jpg" alt="sign up image">
                    </figure>
                    <a href="${pageContext.request.contextPath}/pages/customer/login.jsp" class="signup-image-link">I am already member</a>
                </div>
            </div>
        </div>
    </section>
